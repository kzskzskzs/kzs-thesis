...
\footnotetext[0]{
    ツイート文章は夏目漱石『吾輩は猫である』\cite{夏目}から引用
}
...
\footnotetext[2]{\protect\url{https://github.com/textlint/textlint/tree/master/packages/@textlint/markdown-to-ast}}
\footnotetext[3]{\protect\url{https://github.com/textlint/textlint/tree/master/packages/@textlint/ast-traverse}}
...
\footnotetext[4]{使用サイト参照:　\protect\url{https://www.hayakawabooks.com/n/ncdfb31dc4e46?creator_urlname=hayakawashobo01}}
